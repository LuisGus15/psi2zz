<x-app-layout>
    ...
    <body class="goto-here">
     ...
     <span class="oi oi-menu"></span> Menu
        ...
        <!-- END nav -->
        <section class="ftco-section py-1 bg-white">
            <div class="container">

                <div class="row justify-content-center mb-3 pb-3">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        <h2 class="mb-4">Nuevos Calzados ^.^</h2>
                        <div class="flex justify-end mr-1 mb-1">
                            <a href="{{ route('productos.crear') }}" class="px-1 py-1"bg-white rounded-lg
                                text-black>Crear Producto</a>
                        </div>
                    </div>
                </div>
            </div>
